...
inline static int findIndex(string s, const string stringArray[], int size) {
...
inline static int testConditionFaceIncreasing(Card *card1, Card * card2) {
...
inline static int testConditionFaceDecreasing(Card *card1, Card * card2) {
	return testConditionFaceIncreasing(card2, card1);
}

inline static int testConditionSuitIncreasing(Card *card1, Card * card2) {
...
inline static int testConditionSuitDecreasing(Card *card1, Card * card2) {
	return testConditionSuitIncreasing(card2, card1);
}
inline static void swapCards(Card * card1, Card * card2) {
	Card temp = *card1;
	*card1 = *card2;
	*card2 = temp;
}

inline static void sort(Card * hand, int size, int(*fun_condition)(Card*, Card*)) {
	int compindex, res;
...
inline static void sortFaces(Card hand[], int size) {
...
inline static void sortSuits(Card hand[], int size) {
...
inline static int clampWrapInclusive(int min, int max, int val) {
...
inline static void copyHand(Card originalHand[], int originalSize, Card newHand[], int newSize, int index)
{
...
inline static int consecutiveFace(Card hand[], int size, int numberOfSameFaces) {
	int c = 1;
	int p = 1;
...
inline static int containsPair(Card hand[], int size) {
...
*/
inline static int containsTwoPair(Card hand[], int size) {
...
inline static void printHand(Card hand[], int size) {
...
inline static int consecutiveSuits(Card hand[], int size, int numberOfSameSuits) {
	int c = 1;
	//Card *hand2 = 
	int p = 1;
	sortSuits(hand, size);
...
inline static int threeOfAKind(Card hand[], int size) {
...
/* Checks if a hand has 4 cards with the same face and sorts the hand in ascending order.
 ...
 otherwise it returns 0 */
inline static int fourOfAKind(Card *hand, int size) {
...
otherwise it returns 0.*/
inline static int straight(Card hand[], int size) {
...
otherwise it returns 0.*/
inline static int flush(Card hand[], int size) {
...
otherwise it returns 0.*/
inline static int straightflush(Card hand[], int size) {
...
otherwise it returns 0.*/
inline static int royalFlush(Card hand[], int size) {
...
inline static int fullHouse(Card hand[], int size) {
...
/* Not used */
inline static int compareHands(Card  hand1[], Card hand2[], int sizes, int startIndex, int(*fun_condition)(Card*, Card*), int *indexWhereMisMatch) {
...
inline static string readStrengthDescription(int value) {
	string result;
	switch (value) {
	case ROYALFLUSH:
		result = "royal flush";
...
inline static int describeHand(Card hand[], int size) {
...
inline static void checkHand(Card hand[], int size) {
...
inline static int compareHand(vector<int> *handStr, vector<Card*> *hands, int handsize) {
